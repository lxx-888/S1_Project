 ...
 * Function prototype
 *===========================================================================*/
void EDOGCtrl_Register_IOFunctions(EDOGIO_FUNC_ENUM FuncType, void *fFunc);
...
unsigned char EDOGCtrl_SetSpCamDBFName(char ubFileName[]);
unsigned char EDOGCtrl_SetSpCamManuDBFName(char ubFileName[]);
unsigned char EDOGCtrl_SetMapHeaderName(char ubFileName[]);
