#
#   goahead-linux-cardv.mk -- Makefile to build Embedthis GoAhead for linux
#
...
ME_ROOT_PREFIX        ?= ../../../../../project
ME_BIN_PREFIX         ?= $(ME_ROOT_PREFIX)/release/chip/$(CHIP)/$(PRODUCT)/common/$(TOOLCHAIN)/$(TOOLCHAIN_VERSION)/release/wifi
...
prep:
	...
	@if [ "$(ME_BIN_PREFIX)" = "" ] ; then echo WARNING: ME_BIN_PREFIX not set ; exit 255 ; fi
	@[ ! -x $(BUILD)/bin ] && mkdir -p $(BUILD)/bin; true
	@[ ! -x $(BUILD)/inc ] && mkdir -p $(BUILD)/inc; true
	@[ ! -x $(BUILD)/obj ] && mkdir -p $(BUILD)/obj; true
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/goahead-linux-cardv-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/goahead-linux-cardv-me.h >/dev/null ; then\
		cp projects/goahead-linux-cardv-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
installBinary: $(DEPS_42)
	cp -vf $(BUILD)/bin/goahead $(ME_BIN_PREFIX) ; \
	cp -vf $(BUILD)/bin/libgo.so $(ME_BIN_PREFIX)/libs/ ; \
	chmod 755 "$(ME_BIN_PREFIX)/goahead" ;
