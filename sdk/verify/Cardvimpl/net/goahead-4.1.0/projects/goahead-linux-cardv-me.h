/*
    me.h -- MakeMe Configure Header for linux-arm-cardv
...
/* Settings */
    ...
    #define ME_GOAHEAD_LIMIT_BUFFER 8192
#endif
    ...
    #define ME_GOAHEAD_UPLOAD_DIR "/mnt/mmc"
#endif
...
/* Profile */
    ...
    #define ME_CONFIG_CMD "me -d -q -platform linux-arm-cardv -configure . -gen make"
#endif
#ifndef ME_GOAHEAD_PRODUCT
    #define ME_GOAHEAD_PRODUCT 1
#endif
#ifndef ME_PROFILE
    #define ME_PROFILE "cardv"
#endif
#ifndef ME_TUNE_SIZE
