...
typedef struct Webs {
    ...
    unsigned long   timestamp;          /**< Last transaction with browser */
    ...
    bool            IsRangeActive;      /**If the request content range is active*/
    char            *contentRange;      /**Body content range*/
#if ME_GOAHEAD_CGI
    ...
    ssize           docfd_written;      /**< Bytes of file actually transferred */
