...
::AdjustRtdSmoothing(unsigned rtd)
{
#define SMOOTHING_CNT 3
  static unsigned u32rtd[SMOOTHING_CNT] = {0}, idx = 0;
  u_int32_t u32Tt = 0, i;

  if (idx >= SMOOTHING_CNT)
      idx = 0;
  u32rtd[idx++] = rtd;
  for (i=0; i<SMOOTHING_CNT; i++)
      u32Tt += u32rtd[i];

  u32Tt = u32Tt/SMOOTHING_CNT;
  frtd = (u32Tt*1000)/65536;
}
