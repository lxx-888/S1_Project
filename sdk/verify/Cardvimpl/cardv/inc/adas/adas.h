...
typedef struct _ADAS_results {
    ...
    fcws_info_t*        FCWS_result_L;
    fcws_info_t*        FCWS_result_R;
    fcws_info_t*        FCWS_result_C;
    sag_result*         SAG_result;

    ldws_debug_info*    ldws_debug;
    fcws_debug_info*    fcws_debug_L;
    fcws_debug_info*    fcws_debug_R;
    fcws_debug_info*    fcws_debug_C;
    sag_debug_info*     sag_debug;
} ADAS_results;
//============================== ADAS result ==========================================//

typedef struct _ADAS_enable_params {
	unsigned int		LDWS_enable;
	unsigned int		FCWS_enable;
	unsigned int		SAG_enable;
	unsigned int		BSD_enable;
	unsigned int		BCWS_enable;
} ADAS_enable_params;
...
extern int ADAS_enable(ADAS_enable_params* ADAS_en);
...
extern void ADAS_set_calibration(int calibration_status);
extern void ADAS_set_symmetry(int symmetry_status);
