 ...
 *  @file cmd.h
 *
 *  Prototypes of the Keyword Search (CMD) API functions.
 *
 *  This header file contains all prototypes of the API functions of the Keyword Search (CMD) module.
 */
/*======================================================================================*/
/** @addtogroup DEF
*  @{*/
#ifndef _UVOICE_CMD_H_
#define _UVOICE_CMD_H_
...
*/
cmd_int32_t cmdGetName(cmd_uint16_t index, const char** name);

#ifdef ANDROID
void* cmdSetPrintFunc(void* this_print_func);
#endif
...
*      Returns keywords.
*/
const char* cmdGetKeywords(void);
 ...
 *      Returns CMD_CODE_NORMAL if success or other error code.
 */
cmd_int32_t cmdInit(void* cmdInst);
 ...
 *      Returns CMD_CODE_NORMAL if success or other error code.
 */
cmd_int32_t cmdSetConfig(void* cmdInst, cmd_paramterId parmId, const void* data);
 ...
 *      Returns CMD_CODE_NORMAL if success or other error code.
 */
cmd_int32_t cmdGetConfig(void* cmdInst, cmd_paramterId parmId, void* data);
 ...
 *      Returns CMD_CODE_NORMAL if success or other error code.
 */
cmd_int32_t cmdReset(void* cmdInst);
...
*/
cmd_int32_t cmdProcess(void* cmdInst, const cmd_int16_t* audio, cmd_uint16_t samples, cmd_uint16_t* keyIndex, float* confidence);

/**
 * This function releases the memory allocated by UVoiceCMD_Create().
 *
 * @param
 *     uvoiceCMD -IO: Pointer to the CMD instance.
 */
void cmdDesrtoy(void** cmdInst);

#ifdef __cplusplus
}
#endif

#endif // _UVOICE_CMD_H_
/**@}*/
