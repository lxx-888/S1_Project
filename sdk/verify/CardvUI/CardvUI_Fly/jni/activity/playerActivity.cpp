...
static ZKButton* mBtn_NextFilePtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_PLAYER_Btn_NextFile, onButtonClick_Btn_NextFile,
    ID_PLAYER_sys_back, onButtonClick_sys_back,
...
static S_VideoViewCallback SVideoViewCallbackTab[] = {
    ID_PLAYER_Videoview_video, false, 5, onVideoViewPlayerMessageListener_Videoview_video,
};
...
void playerActivity::onCreate() {
	Activity::onCreate();
    mBtn_NextFilePtr = (ZKButton*)findControlByID(ID_PLAYER_Btn_NextFile);
    msys_backPtr = (ZKButton*)findControlByID(ID_PLAYER_sys_back);
...
void playerActivity::registerActivityTimer() {
...
void playerActivity::unregisterActivityTimer() {
    int tablen = sizeof(REGISTER_ACTIVITY_TIMER_TAB) / sizeof(S_ACTIVITY_TIMEER);
    for (int i = 0; i < tablen; ++i) {
        S_ACTIVITY_TIMEER temp = REGISTER_ACTIVITY_TIMER_TAB[i];
