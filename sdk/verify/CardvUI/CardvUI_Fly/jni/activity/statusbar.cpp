...
static ZKWindow* mwarningmsg_iconPtr;
static ZKTextView* mwarningmsg_textPtr;
static ZKWindow* mwarningmsgPtr;
...
void statusbar::onCreate() {
	BaseApp::onCreate();
    mwarningmsg_iconPtr = (ZKWindow*)findControlByID(ID_STATUSBAR_warningmsg_icon);
    mwarningmsg_textPtr = (ZKTextView*)findControlByID(ID_STATUSBAR_warningmsg_text);
    mwarningmsgPtr = (ZKWindow*)findControlByID(ID_STATUSBAR_warningmsg);
	mstatusbarPtr = this;
	onUI_init();
    // 注册监听全局触摸
