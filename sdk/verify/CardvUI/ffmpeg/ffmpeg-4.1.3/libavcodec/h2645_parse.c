...
#define AUD_CODE 0x46
#define SPS_CODE 0x42
#define PPS_CODE 0x44
#define VPS_CODE 0x40
#define SEI_CODE 0x4e
#define IDR_W_RADL_CODE 0x26
#define TRAIL_CODE 0x02
    ...
    while (si + 2 < length) {
        ...
        else if (src[si] == 0 && src[si + 1] == 0 && src[si + 2] != 0)
        {
            ...
            { // escape
                ...
                if (decoder_type == HARD_DECODING /*&& ((code != VPS_CODE)
                    && (code != SPS_CODE) && (code != PPS_CODE) && (code != AUD_CODE))*/)
                {
                    dst[di++] = 3;
                    si += 3;
                }
